...
class CRFDecoder(nn.Module):
    def __init__(self, num_class, h_size=768):
        super().__init__()
    ...
    def forward(self, encoder_outputs, encoder_mask, labels):
        ...
        loss = self.CRF(emissions=emissions, tags=labels, mask=encoder_mask, reduction='token_mean')
        return -1 * loss
...
# base on code from ->
# https://github.com/kmkurn/pytorch-crf/blob/master
